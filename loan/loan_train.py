...
def train(args):
    ...
    model = ScalableMonotonicNeuralNetwork(input_size = 28,
                                            mono_size = 5,
                                            mono_feature = np.asarray([0,1,2,3,4]),
